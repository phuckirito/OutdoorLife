                ...
                <table class="table table-light">
                    ...
                    <c:forEach var="a" items="${orders}">
                        <tr>
                            ...
                            <td><a href="order-detail?id=${a.orderId}&action=admin" class="btn btn-sm btn-success">View Detail</a></td>
                            <td>
                                <c:if test="${a.approveStatus == false && not empty currentUser && currentUser.staff}">
                                    <a href="approve-order?id=${a.orderId}&action=status" class="btn btn-sm btn-primary">Approve Order</a>
                                </c:if>
                            </td>
                            <td>
                                <c:if test="${a.paymentStatus == false && not empty currentUser && currentUser.staff}">
                                    <a href="approve-order?id=${a.orderId}&action=payment" class="btn btn-sm btn-warning">Approve Payment</a>
                                </c:if>
                            </td>
