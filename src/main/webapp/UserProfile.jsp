                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body text-center">
                        <div class="profile-avatar mb-4">
                            <img src="img/avatar.png" alt="User Avatar" class="rounded-circle" width="150">
                        </div>
                        <h3 class="mb-3"><%= session.getAttribute("username") %></h3>
                        <p class="text-muted mb-3"><i class="fas fa-envelope me-2"></i><%= session.getAttribute("email") %></p>
                        <p class="text-muted mb-4"><i class="fas fa-phone me-2"></i><%= session.getAttribute("phone") %></p>
