    ...
    <div class="container-fluid service py-5 bg-light">
        <div class="container py-5">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="service-item">
                        ...
                        <div class="service-link">
                            ...
                            <a href="form_book.jsp" class="btn btn-secondary mt-3">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="service-item">
                        ...
                        <div class="service-link">
                            <a href="detail2.jsp" class="btn btn-primary mt-3">View Detail</a>
                            <a href="form_book.jsp" class="btn btn-secondary mt-3">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="service-item">
                        <img src="img/river3realjpg.jpg" class="img-fluid w-100" alt="Image">
                        <div class="service-link">
                            <a href="detail3.jsp" class="btn btn-primary mt-3">View Detail</a>
                            <a href="form_book.jsp" class="btn btn-secondary mt-3">Book Now</a>
                        </div>
                    </div>
                </div>
