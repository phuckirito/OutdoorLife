...
<body>
                    ...
                    <div class="card border-e shadow rounded-3 w-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 d-flex justify-content-between">
                                <a href="cartservlet?id=${g.gearId}&redirectPage=/Login/gearcontroller?action=viewtent" class="btn btn-primary">Add to Cart</a>
    ...
    <script type="text/javascript">
        ...
        let itemsPerPage = 8;
        let totalPagesTents = ${totalPagesTents};
        let currentPage = ${currentPage};

        // Initialize pagination plugin
        $('#pagination').twbsPagination({
            startPage: currentPage,
            totalPages: totalPagesTents,
            visiblePages: 10,
